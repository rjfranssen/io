...
subtitle: Walk through the Twitter API and the rtweet package and analyze sentiment across the Twitterverse.
author: Robert Franssen
date: '2020-12-30'
draft: false
excerpt: Walk through the Twitter API and the rtweet package and analyze sentiment across the Twitterverse.
...
## 1 15755669 1352012085891379200 2021-01-20 21:56:15 NBCPhiladel~ Where wa~ Socia~
## 2 15755669 1351285671613313027 2021-01-18 21:49:44 NBCPhiladel~ Presiden~ Socia~
## 3 15755669 1350143610642178051 2021-01-15 18:11:35 NBCPhiladel~ JUST IN:~ Socia~
## 4 15755669 1351645424705294336 2021-01-19 21:39:16 NBCPhiladel~ UPDATE: ~ Socia~
## 5 15755669 1349945940740866048 2021-01-15 05:06:07 NBCPhiladel~ Philadel~ Socia~
## 6 15755669 1349821665010712583 2021-01-14 20:52:18 NBCPhiladel~ The Pa. ~ Socia~
...
## 1 Where w~ en    <chr [1~ <chr [~              0             0    NA    NA NBC1~
## 2 Preside~ en    <chr [1~ <chr [~            100             6    NA    NA NBC1~
...
* *[knitr](https://bioconductor.org/packages/3.13/knitr)* 
* *[rtweet](https://bioconductor.org/packages/3.13/rtweet)* <a id='cite-rtweet-package'></a>(<a href='https://joss.theoj.org/papers/10.21105/joss.01829'>Kearney, 2019</a>)
* *[rmarkdown](https://bioconductor.org/packages/3.13/rmarkdown)* 
* *[NLP](https://bioconductor.org/packages/3.13/NLP)* <a id='cite-Hornik_2020'></a>(<a href='https://CRAN.R-project.org/package=NLP'>Hornik, 2020</a>)
* *[tm](https://bioconductor.org/packages/3.13/tm)* 
* *[RColorBrewer](https://bioconductor.org/packages/3.13/RColorBrewer)* <a id='cite-Neuwirth_2014'></a>(<a href='https://CRAN.R-project.org/package=RColorBrewer'>Neuwirth, 2014</a>)
* *[wordcloud](https://bioconductor.org/packages/3.13/wordcloud)* <a id='cite-Fellows_2018'></a>(<a href='https://CRAN.R-project.org/package=wordcloud'>Fellows, 2018</a>)
* *[topicmodels](https://bioconductor.org/packages/3.13/topicmodels)* <a id='cite-Grun_2011'></a>(<a href='https://doi.org/10.18637/jss.v040.i13'>Grün and Hornik, 2011</a>)
* *[SnowballC](https://bioconductor.org/packages/3.13/SnowballC)* <a id='cite-Bouchet-Valat_2020'></a>(<a href='https://CRAN.R-project.org/package=SnowballC'>Bouchet-Valat, 2020</a>)
* *[config](https://bioconductor.org/packages/3.13/config)* <a id='cite-Allaire_2020'></a>(<a href='https://CRAN.R-project.org/package=config'>Allaire, 2020</a>)
* *[dplyr](https://bioconductor.org/packages/3.13/dplyr)* <a id='cite-Wickham_2021'></a>(<a href='https://CRAN.R-project.org/package=dplyr'>Wickham, François, Henry, and Müller, 2021</a>)
* *[tidytext](https://bioconductor.org/packages/3.13/tidytext)* <a id='cite-Silge_2016'></a>(<a href='http://dx.doi.org/10.21105/joss.00037'>Silge and Robinson, 2016</a>)
* *[tidyr](https://bioconductor.org/packages/3.13/tidyr)* <a id='cite-Wickham_2021a'></a>(<a href='https://CRAN.R-project.org/package=tidyr'>Wickham, 2021</a>)
* *[ggplot2](https://bioconductor.org/packages/3.13/ggplot2)* <a id='cite-Wickham_2016'></a>(<a href='https://ggplot2.tidyverse.org'>Wickham, 2016</a>)
* *[lubridate](https://bioconductor.org/packages/3.13/lubridate)* <a id='cite-Grolemund_2011'></a>(<a href='https://www.jstatsoft.org/v40/i03/'>Grolemund and Wickham, 2011</a>)
* *[readr](https://bioconductor.org/packages/3.13/readr)* <a id='cite-Wickham_2021ab'></a>(<a href='https://CRAN.R-project.org/package=readr'>Wickham and Hester, 2021</a>)
* *[skimr](https://bioconductor.org/packages/3.13/skimr)* <a id='cite-Waring_2021'></a>(<a href='https://CRAN.R-project.org/package=skimr'>Waring, Quinn, McNamara, Arino de la Rubia, et al., 2021</a>)
* *[BiocStyle](https://bioconductor.org/packages/3.13/BiocStyle)* 
...
* *[devtools](https://CRAN.R-project.org/package=devtools)* <a id='cite-Wickham_2021abc'></a>(<a href='https://CRAN.R-project.org/package=devtools'>Wickham, Hester, and Chang, 2021</a>)
