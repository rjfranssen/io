---
title: "Create a Custom Color Palette in R"
subtitle: Maintain brand consisteny by using a consistent color scheme across all of your data visualizations.
author: Robert Franssen
date: '2020-12-30'
draft: false
excerpt: Create your own color palette in R and use it with ggplot to maintain uniformity across data visualizations.
layout: single
...
First, find a bunch of colors that you like. [Canva](https://www.canva.com/) is a good place to go for inspiration; or, use this [tool from Adobe Color](https://color.adobe.com/create/image) that will extract colors from a photo you like. Then, there's always [colorbrewer2](https://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3).  

_In many cases, you can simply use `scale_color_manual()` and `scale_fill_manual()` functions directly within ggplot2. See [the ggplot2 docs](https://ggplot2.tidyverse.org/reference/scale_manual.html) for examples._
