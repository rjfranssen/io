...
subtitle: Use RMarkdown and Knitr to generate multiple interactive reports based on a set of parameters.
author: Robert Franssen
date: '2021-01-16'
draft: false
excerpt: Use RMarkdown and Knitr to generate multiple interactive reports based on a set of parameters.
...
* *[devtools](https://CRAN.R-project.org/package=devtools)* <a id='cite-Wickham_2021'></a>(<a href='https://CRAN.R-project.org/package=devtools'>Wickham, Hester, and Chang, 2021</a>)
