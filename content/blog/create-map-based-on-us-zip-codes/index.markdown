...
subtitle: Create a pannable, zoomable, customizeable, geographical representation of numeric values using R and Leaflet.
author: Robert Franssen
date: '2021-01-03'
draft: false
excerpt: Create a pannable, zoomable, customizeable, geographical representation of numeric values using R and Leaflet.
...
* *[rgdal](https://bioconductor.org/packages/3.13/rgdal)* <a id='cite-Bivand_2021'></a>(<a href='https://CRAN.R-project.org/package=rgdal'>Bivand, Keitt, and Rowlingson, 2021</a>)
* *[leaflet](https://bioconductor.org/packages/3.13/leaflet)* <a id='cite-Cheng_2021'></a>(<a href='https://CRAN.R-project.org/package=leaflet'>Cheng, Karambelkar, and Xie, 2021</a>)
...
* *[data.table](https://bioconductor.org/packages/3.13/data.table)* <a id='cite-Dowle_2021'></a>(<a href='https://CRAN.R-project.org/package=data.table'>Dowle and Srinivasan, 2021</a>)
* *[htmlwidgets](https://bioconductor.org/packages/3.13/htmlwidgets)* <a id='cite-Vaidyanathan_2021'></a>(<a href='https://CRAN.R-project.org/package=htmlwidgets'>Vaidyanathan, Xie, Allaire, Cheng, et al., 2021</a>)
* *[BiocStyle](https://bioconductor.org/packages/3.13/BiocStyle)* <a id='cite-Oles_2021'></a>(<a href='https://github.com/Bioconductor/BiocStyle'>Oles, 2021</a>)
...
* *[devtools](https://CRAN.R-project.org/package=devtools)* <a id='cite-Wickham_2021a'></a>(<a href='https://CRAN.R-project.org/package=devtools'>Wickham, Hester, and Chang, 2021</a>)
